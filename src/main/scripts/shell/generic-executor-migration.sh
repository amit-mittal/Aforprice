...
COMMAND="$JAVA_HOME/bin/java -verbosegc -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:HeapDumpPath=/var/log/crawler -XX:-HeapDumpOnOutOfMemoryError -XX:ParallelGCThreads=2 -Xms1G -Xmx14G $OPTIONS -cp $CLASSPATH $MAIN_CLASS $PROGRAM_ARGS"
