...
COMMAND="$JAVA_HOME/bin/java -verbosegc -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:HeapDumpPath=/var/log/crawler -XX:ParallelGCThreads=2 -XX:-HeapDumpOnOutOfMemoryError -XX:MaxGCPauseMillis=500 -Xms256M -Xmx8G $OPTIONS -cp $CLASSPATH $MAIN_CLASS $PROGRAM_ARGS"
