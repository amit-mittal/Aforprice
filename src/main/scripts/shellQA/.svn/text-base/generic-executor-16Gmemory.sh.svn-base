...
DEPLOYMENT_HOME=/home/batchprod/dist/trunk
...
COMMAND="$JAVA_HOME/bin/java -verbosegc -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:HeapDumpPath=/var/log/crawler -XX:ParallelGCThreads=2 -XX:-HeapDumpOnOutOfMemoryError -XX:MaxGCPauseMillis=500 -Xms16G -Xmx16G $OPTIONS -cp $CLASSPATH $MAIN_CLASS $PROGRAM_ARGS"
