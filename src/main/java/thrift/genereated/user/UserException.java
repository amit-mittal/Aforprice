...
public class UserException extends TException implements org.apache.thrift.TBase<UserException, UserException._Fields>, java.io.Serializable, Cloneable {
  ...
  public UserException setError_code(int error_code) {
    this.error_code = error_code;
    setError_codeIsSet(true);
    return this;
  }
  ...
  public UserException setError_msg(String error_msg) {
    this.error_msg = error_msg;
    return this;
  }
  ...
  public int compareTo(UserException other) {
    ...
    UserException typedOther = (UserException)other;
