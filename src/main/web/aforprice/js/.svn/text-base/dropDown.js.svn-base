 ...
 * 
 * It is a jQuery plugin to make a dropdown menu.
 * It limitations is that it handles depths of upto 2.
 * 
 * @TODO: increase the depth and make it more generalised to be 
 * used in many other pages for drop down menu facility.
 * */
(function($) {
